...
if __name__ == '__main__':
    ...
    train_loader = load_datasets(params.train_dir, params.train_size, params.batch_size, params.noise_param, params.crop_size, shuffled=True)
    valid_loader = load_datasets(params.valid_dir, params.valid_size, params.batch_size, params.noise_param, params.crop_size, shuffled=False)
